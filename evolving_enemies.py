...
class Genetic_Algorithm():
    ...
    def selection(self,current_population):
        fitness_list = []
        for x in range(6):
            chromosome = current_population[x]
...
def play_function():
    ...
    while RUN_GAME:
        ...
        if GENERATE_GAME_OBJECTS == True:
            ...
            enemy1 = Enemy_Ship(generated_population[selected_chromosome_list[1]], 300, 140, 1)
            enemy2 = Enemy_Ship(generated_population[selected_chromosome_list[2]], 400, 270, 2)
            enemy3 = Enemy_Ship(generated_population[selected_chromosome_list[3]], 200, 400, 3)
